    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', phonenumber_field.modelfields.PhoneNumberField(error_messages={'unique': 'A user with that phone already exists.'}, max_length=128, region=None, unique=True, verbose_name='phone')),
